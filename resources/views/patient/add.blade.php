<x-layout>
    <div class="flex flex-col gap-6 w-full bg-white h-full p-10 rounded-xl">
        ...
        <div class="flex flex-col gap-2 w-full">
            <label for="phone" class="text-gray-500">No Telepon</label>
            <input type="text" name="phone" id="phone" class="bg-gray-100  h-14 rounded-xl p-3" placeholder="Masukan No telepon">
        </div>
